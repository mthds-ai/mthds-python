...
from mthds.package.discovery import MANIFEST_FILENAME, find_package_manifest
from mthds.package.exceptions import ManifestError


def do_list(directory: str | None = None) -> None:
    """Display the package manifest information.

    Walks up from the target directory to find a METHODS.toml and displays its contents.
