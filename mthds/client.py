...
from mthds.exceptions import ClientAuthenticationError, PipelineRequestError
...
from mthds.pipeline import DictPipelineExecuteResponse, DictPipelineStartResponse, PipelineRequest
...
class MthdsAPIClient(RunnerProtocol[DictPipeOutputAbstract]):
    ...
    def __init__(
        ...
        resolved_api_token = api_token or os.getenv("MTHDS_API_KEY")
        ...
        resolved_api_base_url = api_base_url or os.getenv("MTHDS_API_BASE_URL")
